    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_addsRecordPumpCostVolume:
                ...
                if (txtCost.getText().toString().equals("") || (txtVolume.getText().toString().equals(""))) {  // User instruction should they loose track of their required actions
                    Toast.makeText(PumpCostAmountActivity.this, "Enter Total Cost of Refuel & Volume of Fuel Refilled ", Toast.LENGTH_LONG).show();
                } else {  // make string values for sending to next activity
