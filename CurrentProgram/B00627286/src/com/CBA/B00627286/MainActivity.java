...
public class MainActivity extends Activity {
    ...
    public void startPrePumpActivity(View v) {
        try { // Button to start Fuel Activities
    ...
    public void startBusRailActivity(View v) {
        try { // Button to start Bus or Rail Activities
    ...
    public void startWalkCycleActivity(View v) {
        try { // Button to start Walk or Cycle Activities
    ...
    public void startStatsActivity(View v) {
        try { // Button to start Stats Activities
